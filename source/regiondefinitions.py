...
def retreiveRegionInformation(Region,sampleType="MC"):
  ...
  #  Region = {}
    ...
    #regiondict = OrderedDict([('RJ2LA',{Cut("1"),Cut("is2Lep2Jet==1 && lepPt[0]>25 && lepPt[1]>25 && jetPt[0]>30 && jetPt[1] > 30")}  )   ] )
    
    #RegionDict = OrderedDict()


    # cutlist['RJ2LA']     = [Cut("1"),Cut("is2Lep2Jet==1 && lepPt[0]>25 && lepPt[1]>25 && jetPt[0]>30 && jetPt[1] > 30")]
    # cutnames['RJ2LA']    = ["Total","2L2J-Preselection"]
    # RegionLabel['RJ2LA'] = "2L2J-Preselction"
    

    # cutlist['CR2L-VV'] = [Cut("1"), 
    ...
    # cutnames['CR2L-VV'] = ["Total","Preselection","n_{b}^{20,77} veto", "80<m_{ll}<100","m_{jj}>20", "\\frac{minH2P}{minH3P}","0.3<d\phi^{VP}_{VR}<2.8","H5PP_VR>200","RPT_H5PP_VR"]
    # RegionLabel['CR2L-VV'] = "CR2L-VV"

    # RegionLabel['CR2L-TOP'] = "CR2L-TOP"
    # cutlist['CR2L-TOP'] = [Cut("1"),
    ...
    #             Cut("RPT_HT5PP<0.05"), 
    #             Cut("H5PP>400")]
    # cutnames['CR2L-TOP'] =["Total","Preselection","Z-window","40<mjj<250","R_minH2P_minH3P>0.5","0.3<dphiVP<2.8","RPT_HT5PP<0.05","H5PP>400"]
    ...
    #RJ2LA = {}
    #cutlist = cutlist[Region]
    #cutnames= cutnames[Region]
    #RegionLabel = RegionLabel[Region]
    #RegionInformation = {'RJ2LA':{'cutlist':cutlist,'cutnames':cutnames,'regionlabel':RegionLabel}}
    #RegionInformation['RJ2LA']  = {'cutlist':cutlist, 'cutnames':cutnames['RJ2LA'], 'regionlabel':RegionLabel['RJ2LA'], 'regiontype':'preselection'}
    #RegionInformation['CRZ']    = {'cutlist':cutlist,   'cutnames':cutnames['CRZ'],   'regionlabel':RegionLabel['CRZ'],   'regiontype':'preselection'}
    #RegionInformation['CRWZ']   = {'cutlist':cutlist,  'cutnames':cutnames['CRWZ'],  'regionlabel':RegionLabel['CRWZ'],  'regiontype':'preselection'}
    #RegionInformation['CRZZ']   = {'cutlist':cutlist['CRZZ'],  'cutnames':cutnames['CRZZ'],  'regionlabel':RegionLabel['CRZZ'],  'regiontype':'preselection'}
    #RegionInformation['CRTOP']  = {'cutlist':cutlist['CRTOP'], 'cutnames':cutnames['CRTOP'], 'regionlabel':RegionLabel['CRTOP'], 'regiontype':'preselection'}
    
    
    #RegionInformation['CR2L-VV']   = {'cutlist':cutlist['CR2L-VV'],  'cutnames':cutnames['CR2L-VV'],  'regionlabel':RegionLabel['CR2L-VV'],'regiontype':'CRVV'}
    #RegionInformation['CR2L-TOP']  = {'cutlist':cutlist['CR2L-TOP'], 'cutnames':cutnames['CR2L-TOP'], 'regionlabel':RegionLabel['CR2L-TOP'],'regiontype':'CRTOP'}
    #RegionInformation['VR2L-VV']   = {'cutlist':cutlist['VR2L-VV'],  'cutnames':cutnames['VR2L-VV'],  'regionlabel':RegionLabel['VR2L-VV'],'regiontype':'VRVV'}
    #RegionInformation['VR2L-TOP']  = {'cutlist':cutlist['VR2L-TOP'], 'cutnames':cutnames['VR2L-TOP'], 'regionlabel':RegionLabel['VR2L-TOP'],'regiontype':'VRTOP'}
     

    #RegionInformation['CR2L_ISR-VV']   = {'cutlist':cutlist['CR2L_ISR-VV'],  'cutnames':cutnames['CR2L_ISR-VV'],  'regionlabel':RegionLabel['CR2L_ISR-VV'],'regiontype':'CRVV'}
    #RegionInformation['CR2L_ISR-TOP']  = {'cutlist':cutlist['CR2L_ISR-TOP'], 'cutnames':cutnames['CR2L_ISR-TOP'], 'regionlabel':RegionLabel['CR2L_ISR-TOP'],'regiontype':'CRTOP'}
    #RegionInformation['VR2L_ISR-VV']   = {'cutlist':cutlist['VR2L_ISR-VV'],  'cutnames':cutnames['VR2L_ISR-VV'],  'regionlabel':RegionLabel['VR2L_ISR-VV'],'regiontype':'VRVV'}
    #RegionInformation['VR2L_ISR-TOP']  = {'cutlist':cutlist['VR2L_ISR-TOP'], 'cutnames':cutnames['VR2L_ISR-TOP'], 'regionlabel':RegionLabel['VR2L_ISR-TOP'],'regiontype':'VRTOP'}
    ...
    #RJ2LA  = OrderedDict([
    #  ('RJ2LA',{'cutlist':cutlist,'cutnames':cutnames,'regionlabel':RegionLabel})
  #])
