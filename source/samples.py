...
def sampleConfiguration(DataPeriods):
  ...
  #  'Vgamma1516'       :{'type':'bkg' , 'year':'1516',  'legend':'V+gamma'    ,   'fillcolor':myLighterOrange, 'filename':'Vgamma'+bkg_suffix},
    ...
    ('lowMassDY1516'    ,{'type':'bkg' , 'year':'1516',  'legend':'DY',   'fillcolor':myLightGrey    , 'filename':'lowMassDY'+bkg_suffix})]
  ...
  #  'Vgamma1516'       :{'type':'bkg' , 'year':'1516',  'legend':'V+gamma'    ,   'fillcolor':myLighterOrange, 'filename':'Vgamma'+bkg_suffix},
    ...
    ('lowMassDY17'    ,{'type':'bkg' , 'year':'17',  'legend':'DY',   'fillcolor':myLightGrey    , 'filename':'lowMassDY'+bkg_suffix})]
  )
