...
CR2L= ["CR2L-VV"]
CR2L=["SR2L_ISR","SR2L_LOW","SR2L_INT","SR2L_HIGH"]
for REGION in CR2L:
	os.system("python rootpy2DPlotter.py  --output " + outputlocation + " --region " + REGION + " --dataperiods 1516 ")
